...
var _ ObjectStore = (*AlibabaObjectStore)(nil)
...
func (b *AlibabaObjectStore) ListBuckets() ([]*storage.BucketInfo, error) {
	svc, err := createAlibabaOSSClient(b.region, b.secret)
	if err != nil {
		return nil, err
	}
	...
	var bucketList []*storage.BucketInfo
	for _, bucket := range buckets.Buckets {
		...
		bucketInfo := &storage.BucketInfo{Name: bucket.Name, Managed: false}
